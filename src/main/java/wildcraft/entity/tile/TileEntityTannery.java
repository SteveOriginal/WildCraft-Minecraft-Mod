package wildcraft.entity.tile;

import wildcraft.block.BlockTannery;
import wildcraft.core.ModItems;
import wildcraft.recipes.TanneryRecipes;
...
public class TileEntityTannery extends TileEntity implements ISidedInventory
{
	...
	public boolean shouldRenderItem1 = true;
	...
	public ItemStack decrStackSize(int i, int mumberOfItems)
	{
		if (this.furnaceItemStacks[i] != null)
		{
			...
			else
			{
				...
				{
					shouldRenderItem1 = false;
					this.furnaceItemStacks[i] = null;
				}else{
					shouldRenderItem1 = true;
	...
	{
		return this.hasCustomInventoryName() ? this.name : "container.wildcraft.tannery";
	}
	...
	public void func_145951_a(String name)
	{
		...
		public void updateEntity()
		{
			...
			{
				worldObj.setBlockMetadataWithNotify(this.xCoord, this.yCoord, this.zCoord, this.worldObj.getBlockMetadata(xCoord, yCoord, zCoord), 2);
			}
			...
			if (!this.worldObj.isRemote)
			{
				...
				{
					flag1 = true;
					BlockTannery.updateTanneryBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
				}
			}
		...
		private boolean canSmelt()
		{
			...
			{
				ItemStack itemstack = TanneryRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
		...
		public static int getItemBurnTime(ItemStack stack)
		{
			...
			else
			{
				 ...
				 if(stack.getItem() != null){
					if (stack.getItem() == ModItems.chemicalBottle && stack.getItemDamage() == 0) return 1000;
				}
		...
		{
			return var2 != 0 || i != 1 || item.getItem() == Items.glass_bottle;
		}
	}
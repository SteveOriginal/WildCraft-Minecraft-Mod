...
public class ContainerTannery extends Container
{
    ...
    public ContainerTannery(InventoryPlayer player, TileEntityTannery tileEntity)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int i)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (TanneryRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityTannery.isItemFuel(itemstack1))
                {
